/* 
===============================================================================================================================
Proyecto Integrador RavenStack
Fase 5. Vistas base creadas para el diagnostico sobre el dataset ravenstack_gemelo
===============================================================================================================================

POR QUE ESTE FICHERO EXISTE APARTE DEL SCRIPT DE DIAGNÓSTICO DE CHURN:

La auditoria del dataset original dejó conviviendo dos vistas con dos definiciones distintas del churn (en la columna es_churn):

    'es_churn' en la vista rfm_por_cuenta -> mostraba toda cuenta con algún evento registrado.
    'es_churn' en la vista estado_churn_cuenta  -> mostraba el último evento de la cuenta que era una baja sin reactivación.

Sobre RavenStack esa contradicción no suponía un problema porque todos los resultados eran planos bajo cualquiera de las dos. 
Pero si empleara la vista RFM_por_cuenta sobre el gemelo se contaminaría cualquier comparacion entre grupos.

Los cambios empleados en las vistas para este nuevo análisis de churn, 
aplicando el principio de analizar sobre UNA SOLA FUENTE DE VERDAD, son los siguientes:

  - estado_churn_cuenta -> Se conserva sin cambios porque define QUIÉN se fue.   
  - RFM_por_cuenta --> se elimina. Se substituye por: metricas_por_cuenta
  - metricas_por_cuenta -> pretende igualmente medir el comportamiento del usuario pero sin columna es_churn.

Cualquier consulta que necesite ambas cosas une las dos vistas por account_id.
===============================================================================================================================
*/
...
/* 
=============================================================================================================================== 
sistema_alerta_recomendador.sql | Proyecto Integrador RavenStack
...
/*  -- PIEZA 3 -- VISTA MATRIZ QUE CRUZA EL RIESGO POR EL VALOR EXPUESTO DE CADA CUENTA  */ -- página 55
...
/* 
=============================================================================================================================== 
power_bi_vistas.sql | Proyecto Integrador RavenStack
Autora: Marta Quevedo Oltra | Unicorn Edition 13.0
